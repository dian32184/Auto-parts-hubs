                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="<?php echo e(route('admin.index')); ?>" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="<?php echo e(asset('images/logo/logo.png')); ?>"
                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="<?php echo e(route('supplier.add')); ?>" class="">
                                                <div class="text">New Supplier</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="<?php echo e(route('suppliers')); ?>" class="">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="<?php echo e(route('admin.inventory.index')); ?>" class="">
                                                <div class="text">Inventory List</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="<?php echo e(route('admin.inventory.create')); ?>" class="">
                                                <div class="text">Add Inventory</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="<?php echo e(route('admin.inventory.stock-in.form')); ?>" class="">
                                                <div class="text">Stock In</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="<?php echo e(route('admin.inventory.stock-out.form')); ?>" class="">
...
</html><?php /**PATH C:\xampp\htdocs\Auto-Parts-Hub-main\resources\views/layouts/admin.blade.php ENDPATH**/ ?>