...
unset($__errorArgs, $__bag); ?>" id="contact_person" name="contact_person" value="<?php echo e(old('contact_person')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?php $__errorArgs = ['contact_person_phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="contact_person_phone" name="contact_person_phone" value="<?php echo e(old('contact_person_phone')); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo e(route('suppliers')); ?>" class="tf-button btn-secondary">Cancel</a>
                </div>
            </div>
        </form>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Auto-Parts-Hub-main\resources\views/supplier/create.blade.php ENDPATH**/ ?>