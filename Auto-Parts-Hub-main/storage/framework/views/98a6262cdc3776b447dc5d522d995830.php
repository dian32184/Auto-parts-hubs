...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-style-1" action="<?php echo e(route('admin.inventory.stock-in')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <fieldset class="name">
...
unset($__errorArgs, $__bag); ?>
                ...
                <fieldset class="name">
                    <div class="body-title">Quantity to Add <span class="tf-color-1">*</span></div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bot">
                    <div></div>
                    <button class="tf-button w208" type="submit">Add Stock</button>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Auto-Parts-Hub-main\resources\views\admin\inventory\stock-in.blade.php ENDPATH**/ ?>