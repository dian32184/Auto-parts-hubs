...
<main>
    <section class="swiper-container js-swiper-slider swiper-number-pagination slideshow" data-settings='{
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
              <img loading="lazy" src="{{asset('assets/images/home/slideshow-engine.png')}}" width="542" height="733"
        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
              <img loading="lazy" src="{{asset('assets/images/home/slideshow-brake.png')}}" width="400" height="733"
        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
              <img loading="lazy" src="{{asset('assets/images/home/slideshow-electrical.png')}}" width="400" height="690"
    ...
    <section class="category-carousel container">
      ...
      <div class="position-relative">
        <div class="swiper-container js-swiper-slider" data-settings='{
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img loading="lazy" class="w-100 h-auto mb-3" src="{{asset('assets/images/categories/engine.png')}}" width="124"
                height="124" alt="Engine Parts" />
              <div class="text-center">
                <a href="{{ route('shop.category', ['slug' => 'engine-parts']) }}" class="menu-link fw-medium">Engine<br />Parts</a>
              </div>
            </div>
            <div class="swiper-slide">
              <img loading="lazy" class="w-100 h-auto mb-3" src="{{asset('assets/images/categories/transmission.png')}}" width="124"
                height="124" alt="Transmission" />
              <div class="text-center">
                <a href="{{ route('shop.category', ['slug' => 'transmission']) }}" class="menu-link fw-medium">Transmission<br />Parts</a>
              </div>
            </div>
            <div class="swiper-slide">
              <img loading="lazy" class="w-100 h-auto mb-3" src="{{asset('assets/images/categories/brake.png')}}" width="124"
                height="124" alt="Brake System" />
              <div class="text-center">
                <a href="{{ route('shop.category', ['slug' => 'brake-system']) }}" class="menu-link fw-medium">Brake<br />System</a>
              </div>
            </div>
            <div class="swiper-slide">
              <img loading="lazy" class="w-100 h-auto mb-3" src="{{asset('assets/images/categories/suspension.png')}}" width="124"
                height="124" alt="Suspension" />
              <div class="text-center">
                <a href="{{ route('shop.category', ['slug' => 'suspension']) }}" class="menu-link fw-medium">Suspension<br />Parts</a>
              </div>
            </div>
            <div class="swiper-slide">
              <img loading="lazy" class="w-100 h-auto mb-3" src="{{asset('assets/images/categories/electrical.png')}}" width="124"
                height="124" alt="Electrical" />
              <div class="text-center">
                <a href="{{ route('shop.category', ['slug' => 'electrical-system']) }}" class="menu-link fw-medium">Electrical<br />System</a>
              </div>
            </div>
            <div class="swiper-slide">
              <img loading="lazy" class="w-100 h-auto mb-3" src="{{asset('assets/images/categories/exhaust.png')}}" width="124"
                height="124" alt="Exhaust" />
              <div class="text-center">
                <a href="{{ route('shop.category', ['slug' => 'exhaust']) }}" class="menu-link fw-medium">Exhaust<br />System</a>
              </div>
            </div>
            <div class="swiper-slide">
              <img loading="lazy" class="w-100 h-auto mb-3" src="{{asset('assets/images/categories/filters.png')}}" width="124"
                height="124" alt="Filters" />
              <div class="text-center">
                <a href="{{ route('shop.category', ['slug' => 'filters']) }}" class="menu-link fw-medium">Filters &<br />Fluids</a>
              </div>
            </div>
            <div class="swiper-slide">
              <img loading="lazy" class="w-100 h-auto mb-3" src="{{asset('assets/images/categories/body.png')}}" width="124"
                height="124" alt="Body Parts" />
              <div class="text-center">
                <a href="{{ route('shop.category', ['slug' => 'body-parts']) }}" class="menu-link fw-medium">Body<br />Parts</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="featured-products container py-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('shop.index') }}" class="btn btn-link">View All Parts</a>
        </div>
                    ...
                    <div class="product-card">
                        <div class="product-card-image position-relative">
                            <a href="{{ route('shop.product.details', ['slug' => $product->slug]) }}">
                                <img src="{{ asset('uploads/products/'.$product->image) }}" alt="{{ $product->name }}" class="w-100">
                            </a>
                            ...
                            <div class="product-actions position-absolute start-0 bottom-0 w-100 p-3">
                                ...
                                <button class="btn btn-outline-light w-100 add-to-wishlist" data-product-id="{{ $product->id }}">
                        ...
                        <div class="product-card-content p-3">
                            <h3 class="product-title fs-5 mb-2">
                                <a href="{{ route('shop.product.details', ['slug' => $product->slug]) }}" class="text-dark text-decoration-none">
                                    {{ $product->name }}
                                </a>
                            </h3>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="product-price">
                                    @if($product->discount_percentage > 0)
                                    <del class="text-muted me-2">${{ number_format($product->regular_price, 2) }}</del>
        ...
        <div class="row g-4">
            <div class="col-md-6">
                <div class="promo-banner position-relative">
                    <img src="{{ asset('assets/images/banners/performance-parts.jpg') }}" alt="Performance Parts" class="w-100">
                    <div class="promo-content position-absolute start-0 top-50 translate-middle-y p-4">
                        ...
                        <a href="{{ route('shop.category', ['slug' => 'performance-parts']) }}" class="btn btn-light">Shop Performance</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="promo-banner position-relative">
                    <img src="{{ asset('assets/images/banners/maintenance-parts.jpg') }}" alt="Maintenance Parts" class="w-100">
                    <div class="promo-content position-absolute start-0 top-50 translate-middle-y p-4">
                        <h3 class="text-white mb-3">Maintenance Essentials</h3>
                        <p class="text-white mb-3">Keep your vehicle in top condition</p>
                        <a href="{{ route('shop.category', ['slug' => 'maintenance']) }}" class="btn btn-light">Shop Maintenance</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="hot-deals container">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 col-xl-20per d-flex align-items-center flex-column justify-content-center py-4 align-items-md-start">
                ...
                <a href="{{ route('shop.category', ['slug' => 'special-offers']) }}" class="btn-link default-underline text-uppercase fw-medium mt-3">View All Offers</a>
            </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide product-card product-card_style3">
                                <div class="pc__img-wrapper">
                                    ...
                                    @if($product->discount_percentage > 0)
                                    <div class="product-label bg-red text-white right-0 top-0 left-auto mt-2 mx-2">-{{ $product->discount_percentage }}%</div>
                                    @endif
                                </div>
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <div class="product-card__price d-flex align-items-center">
                                        ...
                                        <span class="money price text-secondary">${{ number_format($product->sale_price, 2) }}</span>
                                        @else
                                    ...
                                    <div class="anim_appear-bottom position-absolute bottom-0 start-0 d-none d-sm-flex align-items-center bg-body">
                                        ...
                                        <button class="btn-link btn-link_lg me-4 text-uppercase fw-medium js-quick-view"
                                            data-bs-toggle="modal" data-bs-target="#quickView" data-product-id="{{ $product->id }}" title="Quick view">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="category-banner__item border-radius-10 mb-5">
            <img loading="lazy" class="h-auto" src="{{asset('assets/images/banners/performance-parts.jpg')}}" width="690" height="665"
            ...
            <div class="category-banner__item-content">
              ...
              <a href="{{ route('shop.category', ['slug' => 'performance-parts']) }}" class="btn-link default-underline text-uppercase fw-medium">Shop Now</a>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="category-banner__item border-radius-10 mb-5">
            <img loading="lazy" class="h-auto" src="{{asset('assets/images/banners/maintenance.jpg')}}" width="690" height="665"
            ...
            <div class="category-banner__item-content">
              ...
              <a href="{{ route('shop.category', ['slug' => 'maintenance']) }}" class="btn-link default-underline text-uppercase fw-medium">Shop Now</a>
            </div>
          </div>
        </div>
      </div>
