...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-center gap-8 mb-16">
        ...
        <div class="category-card w-80">
            ...
            <div class="h-48 rounded-lg overflow-hidden mb-4">
                <img src="{{ asset('images/categories/engine-parts.jpg') }}" alt="Engine Parts" class="w-full h-full object-cover">
            </div>
        ...
        <div class="category-card w-80">
            ...
            <div class="h-48 rounded-lg overflow-hidden mb-4">
                <img src="{{ asset('images/categories/brake-system.jpg') }}" alt="Brake System" class="w-full h-full object-cover">
            </div>
        ...
        <div class="category-card w-80">
            ...
            <div class="h-48 rounded-lg overflow-hidden mb-4">
                <img src="{{ asset('images/categories/electrical-system.jpg') }}" alt="Electrical System" class="w-full h-full object-cover">
            </div>
    ...
    <div class="grid grid-cols-2 gap-8 mb-12">
        <!-- Motor Parts -->
        <div class="main-category-card relative overflow-hidden rounded-lg h-80">
