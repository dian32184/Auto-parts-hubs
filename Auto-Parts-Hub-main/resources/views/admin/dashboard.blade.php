                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>₱{{ number_format($pendingOrdersAmount ?? 0, 2) }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>₱{{ number_format($completedOrdersAmount ?? 0, 2) }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>₱{{ number_format($cancelledOrdersAmount ?? 0, 2) }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap10">
                            ...
                            <div class="box-icon-trending up">
                                ...
                                <div class="body-title number">{{ number_format($revenueGrowth ?? 0.56, 2) }}%</div>
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="flex items-center gap10">
                            ...
                            <div class="box-icon-trending up">
                                <i class="icon-trending-up"></i>
                                <div class="body-title number">{{ number_format($orderGrowth ?? 0.56, 2) }}%</div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    var options = {
        series: [{
            name: "Revenue",
            data: {!! json_encode($monthlyRevenueChart->pluck('revenue')) !!}
        }],
        chart: {
            height: 350,
            type: 'line',
        ...
        xaxis: {
            categories: {!! json_encode($monthlyRevenueChart->map(function($item) { return date('M Y', mktime(0, 0, 0, $item->month, 1, $item->year)); })) !!}
        }
    };
